...
def remove_duplicates_from_lrc(input_file, output_file):
    ...
    for line in lines:
        ...
        if match:
            ...
            # 规则2：相同的2个字、3个字和4个字重复超过4次
            content = re.sub(r'(..)\1{4,}', r'\1\1\1\1', content)  # 2个字
            content = re.sub(r'(...)\1{4,}', r'\1\1\1\1', content)  # 3个字
            content = re.sub(r'(....)\1{4,}', r'\1\1\1\1', content)  # 4个字
